...
export default function TeacherSettingsPage() {
  ...
  const disablePush = async () => {
    ...
    const payload = { push_enabled: false, push_endpoint: null };
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <button onClick={save} disabled={saving}
                className="rounded-2xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white hover:bg-indigo-700 disabled:opacity-40">
                {saving ? "保存中..." : "保存"}
              </button>
